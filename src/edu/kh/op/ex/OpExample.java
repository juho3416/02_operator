...
public class OpExample { // 예제 코드 작성용 클래스
	...
	public void ex6() {
		...
		System.out.printf("%d은/는 1미만, 100초과 정수인가? : %b / %b\n", input, result2, result3);
	...
	public void ex8() {
		...
		//반환 값이 String이므로 String이다. boolean 아님!
		...
		//System.out.print("정수 입력 : ");
		//inputX = sc.nextInt();
		//System.out.printf(inputX >= 0 ? "양수 입니다" : "음수 입니다");
